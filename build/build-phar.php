...
/**
 * PHAR build script for lphenom/core.
 *
...
$pharFile = $buildDir . '/lphenom-core.phar';

if (file_exists($pharFile)) {
    unlink($pharFile);
}

$phar = new Phar($pharFile, 0, 'lphenom-core.phar');
$phar->startBuffering();
...
$stub = <<<'STUB'
<?php
Phar::mapPhar('lphenom-core.phar');
require 'phar://lphenom-core.phar/vendor/autoload.php';
__HALT_COMPILER();
STUB;
